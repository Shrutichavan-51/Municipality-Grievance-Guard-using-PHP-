...
<head>
    <title>GrievanceGuard|| Area</title>
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="state.php">Area</a></li>
...
<?php } ?>
                                ...
                                <form method="post" name="Category">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <input type="text" placeholder="Enter Area Name"  name="Areas" class="form-control" required>
